...
@Component({
	selector: 'app-garantiahipotecaria',
	templateUrl: './garantiahipotecaria.component.html',
	styleUrls: ['./garantiahipotecaria.component.scss']
})
export class GarantiahipotecariaComponent implements OnInit {
