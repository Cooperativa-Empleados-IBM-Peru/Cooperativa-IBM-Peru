...
@Component({
	selector: 'app-tecnologiahogar',
	templateUrl: './tecnologiahogar.component.html',
	styleUrls: ['./tecnologiahogar.component.scss']
})
export class TecnologiahogarComponent implements OnInit {
