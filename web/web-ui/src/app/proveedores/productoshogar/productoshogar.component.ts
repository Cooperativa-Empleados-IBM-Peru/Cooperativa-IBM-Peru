...
@Component({
	selector: 'app-productoshogar',
	templateUrl: './productoshogar.component.html',
	styleUrls: ['./productoshogar.component.scss']
})
export class ProductoshogarComponent implements OnInit {
