...
@Component({
	selector: 'app-fondosepelio',
	templateUrl: './fondosepelio.component.html',
	styleUrls: ['./fondosepelio.component.scss']
})
export class FondosepelioComponent implements OnInit {
